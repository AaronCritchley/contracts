...
im_float = np.zeros((10, 10, 3), dtype='float32')
rgb_small = np.zeros((10, 10, 3), dtype='uint8')
rgb_large = np.zeros((20, 20, 3), dtype='uint8')

rgba_small = np.zeros((10, 10, 3), dtype='uint8')
rgba_large = np.zeros((20, 20, 3), dtype='uint8')
